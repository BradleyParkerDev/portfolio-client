    ...
    return(
        <div id='aboutpage-container'>
            ...
            <div id='aboutpage-div1' className="flex justify-center mt-[94px] w-[100%]  h-[auto]  border-black border-dashed border-[1px]">
                <div id='ap-div1-inner' className="w-[100%] max-w-[700px]  h-[auto] mr-[20px] ml-[20px]  border-black border-dashed border-[1px]">
            ...
            <div id='ap-content-container' className="mt-[90px] pr-[20px] pl-[20px] tablet:pl-[60px] lg:pl[0px] lg:justify-center mb-[105px] lg:flex w-[100%]  border-black border-dashed border-[1px]">
                <div id='background-interests' className="lg:mr-[150px] h-[auto] max-w-[555px] w-[100%] mb-[40px]  border-black border-dashed border-[1px]">
                    <div id='bi-title' className="h-[auto] w-[100%] font-awakenning antialiased  text-[22px] sm:text-[24px] border-black border-dashed border-[1px]">
                ...
                <div id='skills' className="h-[auto] w-[100%] max-w-[355px] border-black border-dashed border-[1px]">
                    <div id='skills-title' className="h-[auto] w-[100%] font-awakenning  text-[22px] sm:text-[24px] border-black border-dashed border-[1px]">
                        <p>Skills</p>
                    </div>
